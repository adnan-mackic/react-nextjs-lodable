      ...
      <div>
        ...
        <Row form>
          <Col md={{size: 4, offset: 2}}>
            <FormGroup className="mx-4">
              <Col className={classes.check}>
                <Input type="checkbox" name="OptOutCompanyEmail" innerRef={register} /> Opt-Out of
                Company Emails
              </Col>
            </FormGroup>
          </Col>
          <Col md={{size: 4}}>
            <FormGroup className="mx-4">
              <Col className={classes.check}>
                <Input type="checkbox" name="OptOutConsultantEmail" innerRef={register} /> Opt-Out
                of Consultant Emails
              </Col>
            </FormGroup>
          </Col>
        </Row>
